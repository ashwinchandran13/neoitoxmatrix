    ...
    <div className="p-8 mx-auto lg:max-w-6xl md:max-w-2xl ">
      ...
      <div className='relative grid grid-cols-2 gap-2 mt-16 shadow-lg lg:gap-4 md:gap-3 lg:grid-cols-4 backdrop-blur-3xl'>
        {clients.map((client, key) => (
          <div key={key} className='flex justify-center col-span-1 py-10 align-middle border-2 border-green-400 hover:rounded-xl hover:bg-white lg:py-20 md:py-10 backdrop-blur-3xl'>
            <Image
