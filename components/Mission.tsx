...
const Mission = () => {
  return (
      <div className='relative flex w-auto place-items-center' id='mission'>
          <div className='p-4 ml-4 shadow-lg md:p-2 sm:p-1 h-fit w-fit justify-self-center backdrop-blur-sm'>
              <Image 
                src={planning}
                alt='planning'
                width='200'
          ...
          <div className='h-auto p-4 md:p-2 sm:p-1 lg:w-1/2 justify-self-center backdrop-blur-sm'>
          ...
          <div className='h-auto p-4 md:p-2 sm:p-1 lg:w-1/2 md:w-auto justify-self-center backdrop-blur-sm'>
            <h2 className='text-center text-white lg:text-3xl md:text-lg sm:text-xs'>
