...
const Domains = () => {
  ...
  const [maskStyle, setMaskStyle] = useState('mask-app');
  ...
  return (
    <div className='box-border relative object-cover p-0 m-0'>
      ...
      <svg className='absolute top-0 left-0 w-full lg:h-[78vh] md:h-[50vh] sm:h-full'>
        ...
        <mask id="app">
          <rect fill='white' width="100%" height="100%" ></rect>
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 -80 622.88 250.9" width="100%" height="100%">
